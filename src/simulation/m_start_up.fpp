...
#:endif
            ...
            artificial_Ma, pi_fac, adv_n, adap_dt
...
!&>
    ...
    subroutine s_initialize_gpu_vars()
        ...
        !$acc update device(nb, R0ref, Ca, Web, Re_inv, weight, R0, V0, bubbles, polytropic, polydisperse, qbmm, R0_type, ptil, bubble_model, thermal, poly_sigma, adv_n, adap_dt, n_idx, artificial_Ma, pi_fac)

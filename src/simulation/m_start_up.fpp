...
#:endif
            ...
            pi_fac, adv_n, adap_dt, coupling, bf_x, bf_y, bf_z, &
...
!&>
    ...
    subroutine s_initialize_gpu_vars
        ...
        !$acc update device(nb, R0ref, Ca, Web, Re_inv, weight, R0, V0, bubbles, polytropic, polydisperse, qbmm, R0_type, ptil, bubble_model, thermal, poly_sigma, adv_n, adap_dt, n_idx, pi_fac, low_Mach, coupling)
